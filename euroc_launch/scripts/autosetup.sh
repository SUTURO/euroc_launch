...
if [ "$1" == "--with-server" ]
	...
	wget --user=euroc_qualif_c2 --password=4gWHsApa http://projects.laas.fr/euroc/euroc_qualif_c2/native/euroc-c2s1-simulator_1.0.24_i386.deb
	sudo dpkg -i euroc-c2s1-scenes_1.0.25_i386.deb euroc-c2s1-simulator_1.0.24_i386.deb
fi
